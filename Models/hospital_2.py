...
Original file is located at
    https://colab.research.google.com/drive/1mFFRtk8TSKP8I2AvC6V8ouwImqLZ8XMZ
...
zip_ref = zipfile.ZipFile('/content/drive/MyDrive/H2_data.zip', 'r') #Opens the zip file in read mode
...
"""# **Evaluating the updated local model after receiving the global weights :**"""

model1 = tf.keras.models.load_model('model_cnn.h5')
